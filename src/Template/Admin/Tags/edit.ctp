<nav class="col-lg-3 col-sm-4 columns side-menu" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $tag->id), 'class'=>'side-list-content']
            )
        ?></li>
...
<div class="tags form col-lg-8 col-sm-7 columns content main-content-data">
    <?= $this->Form->create($tag) ?>
    <fieldset>
        <legend class="legend-style"><?= __('Edit Tag') ?></legend>
