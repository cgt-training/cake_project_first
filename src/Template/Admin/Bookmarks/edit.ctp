<nav class="col-lg-3 medium-4 columns side-menu" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $bookmark->id), 'class'=>'side-list-content']
            )
        ?></li>
...
<div class="bookmarks form col-lg-8 medium-8 columns content main-content-data">
    <?= $this->Form->create($bookmark) ?>
    <fieldset>
        <legend class="legend-style"><?= __('Edit Bookmark') ?></legend>
