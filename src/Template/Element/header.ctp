<div class="container-fluid headerbackgroud">
	<div class="container">
	...
	<!-- Main Content start -->
		<div class="container image-backgroud-container">
  			<div class="image-layer text-center">
  				<h4 class="image-layer-heading">Admission open - PGDM</h4>
  				<div class="image-top-layer">POST GRADUATE DIPLOMA IN MANAGEMENT</div>
  				<div class="image-layer-description">Two year full time programme</div>
  				<div class="image-layer-footer"><strong>Specialized in Finance, Marketing and Retail Marketing</strong></div>
  			</div>
		</div>